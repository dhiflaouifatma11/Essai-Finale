...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/pro')) {
            ...
            // registerPro
            if ($pathinfo === '/pro/register') {
                return array (  '_controller' => 'FOSUserBundle:views:Registration:register',  '_route' => 'registerPro',);
            }
        ...
        if (0 === strpos($pathinfo, '/re')) {
            if (0 === strpos($pathinfo, '/register')) {
                ...
                if (rtrim($pathinfo, '/') === '/register') {
                    ...
                    return array (  '_controller' => 'Utilisateurs\\UtilisateursBundle\\Controller\\RegistrationController::registerAction',  '_route' => 'fos_user_registration_register',);
                }
                ...
                if (0 === strpos($pathinfo, '/register/c')) {
                    ...
                    if ($pathinfo === '/register/check-email') {
                        ...
                        return array (  '_controller' => 'Utilisateurs\\UtilisateursBundle\\Controller\\RegistrationController::checkEmailAction',  '_route' => 'fos_user_registration_check_email',);
                    }
                    ...
                    if (0 === strpos($pathinfo, '/register/confirm')) {
                        ...
                        if (preg_match('#^/register/confirm/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'fos_user_registration_confirm')), array (  '_controller' => 'Utilisateurs\\UtilisateursBundle\\Controller\\RegistrationController::confirmAction',));
                        }
                        ...
                        if ($pathinfo === '/register/confirmed') {
                            ...
                            return array (  '_controller' => 'Utilisateurs\\UtilisateursBundle\\Controller\\RegistrationController::confirmedAction',  '_route' => 'fos_user_registration_confirmed',);
                        }
